...
D2FrontendParams::D2FrontendParams(ros::NodeHandle& nh) {
  ...
  superpoint_config.max_keypoints =
      static_cast<int32_t>(fsSettings["max_superpoint_cnt"]);
  superpoint_config.onnx_path =
      static_cast<std::string>(fs_superpoint_config["onnx_path"]);
  superpoint_config.engine_path =
      static_cast<std::string>(fs_superpoint_config["trt_engine_path"]);
  superpoint_config.keypoint_threshold =
      static_cast<float>(fs_superpoint_config["threshold"]);
  ...
  cv::FileNode output_tensor_names =
      fs_superpoint_config["output_tensor_names"];
  for (const auto& name : output_tensor_names) {
    superpoint_config.output_tensor_names.push_back(
        static_cast<std::string>(name));
    printf("output_tensor_names: %s\n", static_cast<std::string>(name).c_str());
  }
  superpoint_config.input_height =
      static_cast<int32_t>(fs_superpoint_config["input_height"]);
  superpoint_config.input_width =
      static_cast<int32_t>(fs_superpoint_config["input_width"]);
  superpoint_config.enable_pca =
      static_cast<int32_t>(fs_superpoint_config["enable_pca"]) != 0;
  superpoint_config.pca_mean_path =
      static_cast<std::string>(fs_superpoint_config["pca_mean_path"]);
  superpoint_config.pca_comp_path =
      static_cast<std::string>(fs_superpoint_config["pca_comp_path"]);
  superpoint_config.superpoint_pca_dims =
      static_cast<int32_t>(fs_superpoint_config["superpoint_pca_dims"]);
  ...
  // nh.param<double>("superpoint_thres", loopcamconfig->superpoint_thres,
  // 0.012); nh.param<std::string>("pca_comp_path", loopcamconfig->pca_comp,
  ...
  ftconfig->stereo_frame_thread_rate =
      static_cast<float>(fsSettings["image_freq"]);
  ftconfig->loop_detection_thread_rate =
      static_cast<float>(fsSettings["loop_detection_freq"]);
...
void D2FrontendParams::readCameraConfigs(cv::FileStorage& fsSettings,
  ...
  int32_t extrinsic_parameter_type =
      static_cast<int32_t>(fsSettings["extrinsic_parameter_type"]);
  if (calib_file_path != "") {
...
void D2FrontendParams::readCameraCalibrationfromFile(
    const std::string& path, int32_t extrinsic_parameter_type) {
...
std::pair<camodocal::CameraPtr, Swarm::Pose> D2FrontendParams::readCameraConfig(
